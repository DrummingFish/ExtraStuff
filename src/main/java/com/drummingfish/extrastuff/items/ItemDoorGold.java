...
public class ItemDoorGold extends ItemDoor {
	...
	public ItemDoorGold(int id, Material par2Material) {
		super(id, par2Material);
		setUnlocalizedName(ItemInfo.DOOR_GOLD_UNLOCALIZED_NAME);
	}
	...
	public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block)
    {
        ...
        boolean flag1;
        	...
        	flag = par0World.getBlockId(par1 - b0, par2, par3 - b1) == par5Block.blockID || par0World.getBlockId(par1 - b0, par2 + 1, par3 - b1) == par5Block.blockID;
        	flag1 = par0World.getBlockId(par1 + b0, par2, par3 + b1) == par5Block.blockID || par0World.getBlockId(par1 + b0, par2 + 1, par3 + b1) == par5Block.blockID;
