...
public class BlockDoorDiamond extends BlockDoor {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        field_111044_a[0] = par1IconRegister.registerIcon(BlockInfo.TEXTURE_LOCATION + ":" + BlockInfo.DOOR_DIAMOND_ICON_UPPER);
        field_111043_b[0] = par1IconRegister.registerIcon(BlockInfo.TEXTURE_LOCATION + ":" + BlockInfo.DOOR_DIAMOND_ICON_LOWER);
    ...
    {
        return Items.diamondDoor.itemID;
    }
}
